...
class MarketsInfoHttpService {
    getHistoricalPrices(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = new request_builder_1.RequestBuilder()
                .withURL(`${baseUrl(params.isDemo)}/${settings_1.API_VERSION_1}/prices/${params.epic}`)
                .build();
            const response = yield capital_http_service_1.default.get(request);
...
exports.default = new MarketsInfoHttpService();
